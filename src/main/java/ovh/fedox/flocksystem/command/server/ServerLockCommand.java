...
/**
 * ServerLockCommand.java - Unlock command for the server
 * <p>
 * Created on 4/1/2025 at 5:55 PM by Fedox.
 * Copyright © 2025 Fedox. All rights reserved.
 */

public final class ServerLockCommand extends SimpleSubCommand {

	public ServerLockCommand(SimpleCommandGroup parent) {
		super(parent, "lock");
	...
	protected void onCommand() {
		...
		RedisManager.getJedis().srem("available-server", target.getServerInfo().getName().toLowerCase());

		Common.tell(player, "Der Server " + target.getServerInfo().getName() + " wurde gesperrt.");
	}
